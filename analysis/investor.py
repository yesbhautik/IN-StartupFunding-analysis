...
class Investor:
    ...
    def biggest_investment(self, investor_name):
        ...
        """
        investments = self.startup[self.startup['investors'].str.contains(
            investor_name)]
    ...
    def invested_subsector(self, investor_name):
        ...
        """
        investments = startup[startup['investors'].str.contains(investor_name)]
        investments_grouped = investments.groupby('subvertical')[
            'amount'].sum()
    ...
    def analyze_investment_types(self, investor_name):
        """
        Analyzes the types of investments made by an investor.

        Args:
            investor_name (str): Name of the investor.

        Returns:
            pandas.DataFrame: DataFrame containing the analyzed investment types.
        """
        investments = startup[startup['investors'].str.contains(investor_name)]
        investments_grouped = investments.groupby('type')['amount'].sum()
        investments_sum_by_type = investments_grouped.reset_index()
