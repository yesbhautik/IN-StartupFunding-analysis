...
This project offers a sophisticated analysis of the Indian startup ecosystem, leveraging advanced data visualization techniques. It aims to provide stakeholders with deep insights into funding trends, investor activities, and startup performance. Utilizing Streamlit for an interactive user experience, alongside Pandas and Plotly for data manipulation and visualization, this project stands as a pivotal tool for entrepreneurs, investors, and analysts interested in the Indian startup landscape.
...
1. Clone the GitHub repository:
   ...
   ```
   git clone https://github.com/yesbhautik/IN-StartupFunding-analysis.git
   ```

2. Navigate to the project directory:

   ```
   cd IN-StartupFunding-analysis
   ```
...
The dataset, curated by Sudalai Rajkumar on Kaggle, encompasses a wide array of data points on Indian startups, including investment rounds, investor details, funding amounts, and sector information. This rich dataset serves as the foundation for our in-depth analysis, enabling users to uncover trends and patterns in the Indian startup ecosystem.
You can find the dataset at the following Kaggle link: [Indian Startup Funding Dataset](https://www.kaggle.com/datasets/sudalairajkumar/indian-startup-funding)
