...
This module encapsulates the functionality for conducting and visualizing comprehensive analyses of the startup funding landscape in India. It leverages Plotly for dynamic visualizations and Streamlit for interactive web presentation.
...
class Overall:
    ...
    def plot_total_funding_mom(self):
        ...
        SubHeader(
            title='Total Amount of Funding in Indian Startups Month-over-month(MoM)',
        ...
        PlotLineChart(
            ...
            layout_title='Total funding in Startups in 10-2022'
        )
    ...
    def plot_total_funded_startup_mom(self):
        ...
        SubHeader(
            title='Total Funded Indian Startups Month-over-month(MoM)',
        ...
        PlotLineChart(
            ...
            layout_title='Total Funded Startups in 10-2022'
        )
