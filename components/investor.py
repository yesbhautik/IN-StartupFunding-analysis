...
This module is dedicated to analyzing and visualizing investor activities within the Indian startup ecosystem. It provides insights into investment patterns, preferred sectors, and investment trends over time, utilizing Streamlit and Plotly for interactive exploration.
...
class Investor:
    ...
    def recent_five_investments(self, investor_name):
        ...
        st.dataframe(
            self.investor_analysis.recent_five_investments(investor_name))
    ...
    def plot_biggest_investment(self, investor_name):
        ...
        biggest_investment_df = self.investor_analysis.biggest_investment(
            investor_name)
    ...
    def plot_invested_type(self, investor_name):
        ...
        investment_type_df = self.investor_analysis.invested_type(
            investor_name)
    ...
    def plot_yoy_investment(self, investor_name):
        ...
        yoy_investment_df = self.investor_analysis.yoy_investment(
            investor_name)
    ...
    def similar_investors(self, investor_name):
        ...
        Returns:
            None
        """
        similar_investors = self.investor_analysis.get_similar_investors(
            investor_name)
