"""
Module: Startup Ecosystem Analysis
This module powers an interactive web application designed for in-depth analysis and visualization of the Indian startup ecosystem. It integrates Streamlit for interactivity, with data processing and visualization powered by Pandas and Plotly.
...
class Main:
    ...
    def home_component(self):
        ...
        # Page configuration
        st.set_page_config(
            layout='wide', page_title="yesbhautik's Startup Analysis", page_icon='📊')
        st.sidebar.title(
    ...
    def overall(self):
        ...
        st.header('Month-over-month(MoM) Analysis',
                  help='Analysis on the basis of month for quick overview.')
        st.divider()
        ...
        selected_option = st.selectbox(
            ...
            ['Total Amount of Funding Month-over-month(MoM)',
                'Total Funded Indian Startups Month-over-month(MoM)']
        )

        st.divider()
        if selected_option == 'Total Amount of Funding Month-over-month(MoM)':
    ...
    def startup(self):
        ...
        if btn:
            ...
            with col1:
                st.metric(
                    'Subsector', self.startup_analysis.subsector(startup_name))
            ...
            with col4:
                st.metric(
                    'Investors', self.startup_analysis.investors(startup_name))
